...
#define S_FUNCTION_NAME MPC_embotech_single_integrator_test_20201017124559_tunkapgen_simulinkBlock
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const MPC_embotech_single_integrator_test_20201017124559_tunkapgen_float *solver_timeout = (const MPC_embotech_single_integrator_test_20201017124559_tunkapgen_float*) ssGetInputPortSignal(S,5);
	const MPC_embotech_single_integrator_test_20201017124559_tunkapgen_float *timeout_estimate_coeff = (const MPC_embotech_single_integrator_test_20201017124559_tunkapgen_float*) ssGetInputPortSignal(S,6);
