% MPC_embotech_single_integrator_test_20201004181950_maximilianstoelzle - a fast solver generated by FORCES PRO v4.0.0
%
%   OUTPUT = MPC_embotech_single_integrator_test_20201004181950_maximilianstoelzle(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = MPC_embotech_single_integrator_test_20201004181950_maximilianstoelzle(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = MPC_embotech_single_integrator_test_20201004181950_maximilianstoelzle(PARAMS) returns 
