...
#define S_FUNCTION_NAME MPC_embotech_single_integrator_test_20201014203740_tunkapgen_simulinkBlockcompact
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const MPC_embotech_single_integrator_test_20201014203740_tunkapgen_float *solver_timeout = (const MPC_embotech_single_integrator_test_20201014203740_tunkapgen_float*) ssGetInputPortSignal(S,1);
	const MPC_embotech_single_integrator_test_20201014203740_tunkapgen_float *timeout_estimate_coeff = (const MPC_embotech_single_integrator_test_20201014203740_tunkapgen_float*) ssGetInputPortSignal(S,2);
	...
	params.timeout_estimate_coeff = *timeout_estimate_coeff;
