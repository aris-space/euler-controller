% MPC_embotech_single_integrator_test_20201014203740_tunkapgen - a fast solver generated by FORCES PRO v4.0.0
%
%   OUTPUT = MPC_embotech_single_integrator_test_20201014203740_tunkapgen(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = MPC_embotech_single_integrator_test_20201014203740_tunkapgen(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = MPC_embotech_single_integrator_test_20201014203740_tunkapgen(PARAMS) returns 
